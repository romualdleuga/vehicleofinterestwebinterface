...
import controller.ReasonForInterestFacade;
...
public class ReasonForInterestController implements Serializable {
    ...
    @EJB
    private controller.ReasonForInterestFacade ejbFacade;
    ...
    private ReasonForInterestFacade getFacade() {
        return ejbFacade;
    }
    ...
    public ReasonForInterest getReasonForInterest(java.lang.String id) {
    ...
    public static class ReasonForInterestControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getReasonForInterest(getKey(value));
        }
