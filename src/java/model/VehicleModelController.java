...
import controller.VehicleModelFacade;
...
public class VehicleModelController implements Serializable {
    ...
    @EJB
    private controller.VehicleModelFacade ejbFacade;
    ...
    private VehicleModelFacade getFacade() {
        return ejbFacade;
    }
    ...
    public VehicleModel getVehicleModel(java.lang.String id) {
    ...
    public static class VehicleModelControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getVehicleModel(getKey(value));
        }
